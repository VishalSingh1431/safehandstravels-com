...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav
        ref={navbarRef}
        className={`w-full border-b border-gray-100/50 bg-white sticky top-0 z-50 transition-shadow duration-300 ${isScrolled ? 'shadow-md' : ''
          }`}
      >
        <div className="mx-auto w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex flex-wrap items-center justify-center gap-x-4 xl:gap-x-6 gap-y-3 text-sm font-semibold text-gray-900 pb-3 border-t border-gray-100/50 pt-3">
            ...
            <Link
              to="/all-india-trips"
              className={`relative flex items-center gap-1.5 whitespace-nowrap transition-all duration-300 px-4 py-2.5 rounded-lg hover:scale-110 active:scale-95 ${location.pathname === '/all-india-trips'
            ...
            >
              <button
                ...
                className={`relative flex items-center gap-1.5 whitespace-nowrap transition-all duration-300 px-4 py-2.5 rounded-lg hover:scale-110 active:scale-95 ${travelDropdownItems.some(item => location.pathname === item.route)
                    ? 'text-[#017233] bg-gradient-to-br from-green-50 to-emerald-50 shadow-sm'
                    : 'hover:text-[#017233] hover:bg-gradient-to-br hover:from-green-50/50 hover:to-emerald-50/50'
                  }`}
              >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {travelDropdownItems.map((item, index) => (
                        <Link
                          key={item.label}
                          to={item.route}
                          className={`relative flex flex-col items-center justify-center gap-2 p-4 rounded-xl transition-all duration-200 group hover:scale-105 active:scale-95 ${location.pathname === item.route
                        ...
                        >
                          ...
                          <span className={`text-sm font-semibold transition-colors ${location.pathname === item.route
                              ? 'text-[#017233]'
            ...
            <Link
              to="/experiences"
              className={`relative flex items-center gap-1.5 whitespace-nowrap transition-all duration-300 px-4 py-2.5 rounded-lg hover:scale-110 active:scale-95 ${location.pathname === '/experiences'
                  ? 'text-[#017233] bg-gradient-to-br from-green-50 to-emerald-50 shadow-sm'
                  : 'hover:text-[#017233] hover:bg-gradient-to-br hover:from-green-50/50 hover:to-emerald-50/50'
                }`}
            >
            ...
            <Link
              to="/customise-trip"
              className={`relative flex items-center gap-1.5 whitespace-nowrap transition-all duration-300 px-4 py-2.5 rounded-lg hover:scale-110 active:scale-95 ${location.pathname === '/customise-trip'
                  ? 'text-[#017233] bg-gradient-to-br from-green-50 to-emerald-50 shadow-sm'
                  : 'hover:text-[#017233] hover:bg-gradient-to-br hover:from-green-50/50 hover:to-emerald-50/50'
                }`}
            >
            ...
            <Link
              ...
              className={`relative flex items-center gap-1.5 whitespace-nowrap transition-all duration-300 px-4 py-2.5 rounded-lg hover:scale-110 active:scale-95 ${location.pathname === '/why-safehands-travels'
                  ? 'text-[#017233] bg-gradient-to-br from-green-50 to-emerald-50 shadow-sm'
                  : 'hover:text-[#017233] hover:bg-gradient-to-br hover:from-green-50/50 hover:to-emerald-50/50'
                }`}
            >
                    ...
                    <div className="ml-4 mt-3 grid grid-cols-2 gap-2 animate-slide-down">
                      {travelDropdownItems.map((item) => (
                        <Link
                          key={item.label}
                          to={item.route}
                          className={`relative flex flex-col items-center justify-center gap-2 p-3 rounded-xl transition-all duration-200 group hover:scale-105 active:scale-95 ${location.pathname === item.route
                              ? 'bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-[#017233]/30 shadow-md'
                              : 'bg-gradient-to-br from-gray-50 to-gray-100/50 border-2 border-transparent hover:border-[#017233]/20 hover:bg-gradient-to-br hover:from-green-50/50 hover:to-emerald-50/50 hover:shadow-md'
                            }`}
                          onClick={() => {
                        ...
                        >
                          ...
                          <span className={`text-xs font-semibold transition-colors ${location.pathname === item.route
                              ? 'text-[#017233]'
                              : 'text-gray-700 group-hover:text-[#017233]'
                            }`}>
                            {item.label}
