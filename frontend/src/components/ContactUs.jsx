        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
          <div className="p-6 md:p-8 lg:p-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              {/* Contact Form */}
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl shadow-lg p-6 md:p-8 border border-blue-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows="5"
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#017233] focus:ring-2 focus:ring-[#017233]/20 outline-none transition-all duration-300 bg-white resize-none"
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-purple-50 to-white rounded-2xl shadow-lg p-6 md:p-8 border border-purple-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Get in Touch</h3>

                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#017233] to-[#01994d] flex items-center justify-center text-white text-xl shadow-lg flex-shrink-0">
                        📍
                      </div>
                      <div>
                        <h4 className="font-bold text-gray-900 mb-1">Address</h4>
                        <p className="text-gray-600 leading-relaxed">
                          Flat No- KCB0040205, Wish Town Klassic, Sector 134, Noida,<br />
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          <a href="mailto:info@safehandstravels.com" className="hover:text-[#017233] transition-colors">
                ...
                {/* Social Media */}
                <div className="bg-gradient-to-br from-teal-50 to-white rounded-2xl shadow-lg p-6 md:p-8 border border-teal-100">
                  <h4 className="font-bold text-gray-900 mb-4">Follow Us</h4>
                  <div className="flex gap-4">
                    <a
                      href="#"
                      className="w-12 h-12 rounded-full bg-gradient-to-br from-[#017233] to-[#01994d] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg"
                      aria-label="Facebook"
                    >
