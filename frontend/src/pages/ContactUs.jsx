                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <a href="tel:+919910173385" className="text-lg font-semibold text-[#017233] hover:underline">
                            +91-9910173385
                          </a>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col">
                          <a href="mailto:info@safehandstravels.com" className="text-lg font-semibold text-[#017233] hover:underline whitespace-nowrap">
                            info@safehandstravels.com
                          </a>
                          <a href="mailto:rohit@safehandstravels.com" className="text-lg font-semibold text-[#017233] hover:underline whitespace-nowrap">
